...
<script>
    ...
    printWindow.document.write('<html><head><title>CIT FUNDS</title>');
    ...
    printWindow.document.write('<h3 style="text-align: center; font-family: Arial, sans-serif;">CIT FUNDS</h3>');

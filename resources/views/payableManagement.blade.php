        ...
        <div class="content-center">
            ...
            <div class="mt-4">
                ...
                <div class="flex items-center space-x-2 mt-5">
                  <select class="border border-black rounded-md px-3 py-1 text-sm focus:ring-2 focus:ring-green-500">
            ...
            <div class="mt-4 flex justify-end">
                <button class="bg-red-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-green-700">
                    Delete
                </button>
            </div>
        </div>

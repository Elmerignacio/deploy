...
//Payable
    ...
    document.getElementById('UserManagementMenu').addEventListener('mouseleave', function() {
        ...
        <div class="content-center">
            ...
            <!-- Header Section -->
            <div class="mt-4">
                <h2 class="text-2xl sm:text-3xl font-semibold text-center md:text-left">USER MANAGEMENT</h2>
                
                <!-- Navigation Links -->
                <div class="flex flex-col md:flex-row space-x-0 md:space-x-6 mt-4 border-b pb-2 text-sm text-center md:text-left">
                    <a href="#" class="text-[17px] font-semibold text-green-700 border-b-2 border-green-700 pb-1">Users</a>
                    <a href="#" class="text-[17px] text-gray-600">Roles</a>
                    <a href="#" class="text-[17px] text-gray-600">Year and Block</a>
                </div>
            </div>
            ...
            <div class="mt-4 overflow-auto">
                <table class="w-full min-w-[600px] border border-black rounded-lg text-sm text-center">
                    <thead>
                        <tr class="bg-green-500 text-white border border-black">
                            <th class="p-2 border border-black"><input type="checkbox"></th>
                    ...
                    <tbody>
                        <tr class="border border-black">
                            ...
                            <td class="p-2 border border-black">21212204</td>
                            <td class="p-2 border border-black">Liza Mae</td>
                            <td class="p-2 border border-black">Daytic</td>
                            <td class="p-2 border border-black">3rd Year A</td>
                            <td class="p-2 border border-black">Student</td>
                            <td class="p-2 border border-black text-green-600 font-semibold">Active</td>
                            <td class="p-2 border border-black text-blue-500 underline cursor-pointer">Edit</td>
                          </tr>
                          <tr class="border border-black">
                            <td class="p-2 border border-black"><input type="checkbox"></td>
                            <td class="p-2 border border-black">21122123</td>
                            <td class="p-2 border border-black">Queen Mary</td>
                            <td class="p-2 border border-black">Villareal</td>
                            <td class="p-2 border border-black">3rd Year A</td>
                            <td class="p-2 border border-black">Student</td>
                            <td class="p-2 border border-black text-green-600 font-semibold">Active</td>
                            <td class="p-2 border border-black text-blue-500 underline cursor-pointer">Edit</td>
                          ...
                          <tr class="border border-black">
                            <td class="p-2 border border-black"><input type="checkbox"></td>
                            <td class="p-2 border border-black">21143942</td>
                            <td class="p-2 border border-black">RickMark</td>
                            <td class="p-2 border border-black">Salvo</td>
                            <td class="p-2 border border-black">3rd Year A</td>
                            <td class="p-2 border border-black">Student</td>
                            <td class="p-2 border border-black text-green-600 font-semibold">Active</td>
                            <td class="p-2 border border-black text-blue-500 underline cursor-pointer">Edit</td>
          ...
          <div class="mt-4 flex space-x-3 justify-right">
            <button class="bg-green-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-green-700">Activate</button>
            <button class="bg-gray-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-gray-700">Archive</button>
        </div>
        </div>
    </div>

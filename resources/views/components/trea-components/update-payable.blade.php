...
>
    ...
    <div class="flex justify-center gap-5 mt-4">
        ...
        <form x-ref="deleteForm" method="POST" action="" class="inline">
            ...
            <button 
                type="submit" 
                class="bg-red-700 hover:bg-red-700 text-white py-2 px-4 rounded"
                @click.prevent="
                    $refs.deleteForm.action = '/payable/delete/' + encodeURIComponent(selectedPayable.description);
        ...
        <form x-ref="updateForm" method="POST" action="" class="inline">
            @csrf
            @method('PUT')
            <input tz   ype="hidden" name="description" x-bind:value="selectedPayable.description">
            ...
            <button 
                ...
                @click.prevent="
                    console.log('Updating payable:', selectedPayable); // Debugging

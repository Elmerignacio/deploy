...
<div class="flex h-screen overflow-auto md:overflow-hidden">
  <aside
    ...
    <nav class="mt-10 ml-4 space-y-2 flex flex-col gap-4 justify-center text-[15px] text-bolds pr-5">
        ...
        <a href="/admin/userDetails" class="flex items-center text-white rounded-md mb-5">
        ...
        <a href="/admin/dashboard" class="flex items-center p-2 text-white hover:bg-green-500 rounded-md">
        ...
        <a href="/admin/studentBalance" class="flex items-center p-2 text-white hover:bg-green-500 rounded-md">
        ...
        <a href="/admin/expense" class="flex items-center p-1 text-white hover:bg-green-500 rounded-md">
        ...
        <a href="/admin/manageUser" class="flex items-center p-2 text-white hover:bg-green-500 rounded-md">

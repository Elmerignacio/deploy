    ...
    <x-trea-components.sidebar :profile="$profile" :firstname="$firstname" :lastname="$lastname">
        ...
        <div class="flex mt-[100px] justify-center h-screen px-4">
            <div class="flex flex-col items-center w-full max-w-md md:max-w-lg lg:max-w-xl">
                <h1 class="text-2xl mb-[70px] text-[#1a4d2e]"><strong>USER ACCOUNT DETAILS</strong></h1>
                <div class="relative w-full bg-[#1a4d2e] text-white p-12 rounded-xl shadow-2xl">
                    ...
                    <div class="text-center mt-8">
                        @if (session('success'))
                            <div id="successModalBackdrop"
                                ...
                                <div id="successModal"
                                    class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full transform scale-90 opacity-0 transition duration-300">
                                    <div class="text-[#1a4d2e] font-semibold text-lg text-center">
                                        {{ session('success') }}
                                    </div>
                                </div>
                            </div>
        ...
        <div id="popupModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-white p-6 rounded-md shadow-md text-center">
                ...
                <button onclick="submitImage()" class="bg-bg-[#1a4d2e] text-white px-4 py-2 rounded-md">Yes</button>
        ...
        <div id="changePasswordModal"class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
            ...
            <div class="bg-[#1a4d2e] text-white rounded-xl w-full max-w-md shadow-xl p-8 relative">

                <button id="closeModalBtn"
                    class="absolute top-4 right-4 text-red-500 hover:text-red-600 text-xl font-bold">&times;</button>
                    ...
                    <div class="w-full max-w-md p-6 rounded ">
                        ...
                        <form method="POST" action="{{ route('password.change') }}">
                            ...
                            <div class="mt-6 text-center">
                                <button type="submit"
                                    class="bg-white text-[#1a4d2e] font-semibold px-6 py-2 rounded-full shadow-md hover:bg-gray-200">
                                    Change Password
                                </button>
                            </div>
                        </form>
